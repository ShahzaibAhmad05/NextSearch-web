    ...
    <div ref={containerRef} className="mb-6 animate-fade-in flex justify-left max-w-3xl w-full">
      <div className="glass-card rounded-2xl p-3 sm:p-5 border border-white/10 w-full">
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex items-center justify-center w-6 h-6 rounded-lg bg-linear-to-br from-green-500 to-green-700">
            <svg
            ...
            {shouldTruncate && (
              <div className="flex justify-center">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm text-green-400 hover:text-green-300 transition-colors group"
                >
